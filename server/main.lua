...
-- Medic Bag
exports.qbx_core:CreateUseableItem(sharedConfig.medic_bag, function(source, item)
    -- when someone “uses” their medic bag, place it on the ground
    TriggerClientEvent('prp-amb:PlaceMedicBag', source)
end)

-- Defibrillator
exports.qbx_core:CreateUseableItem(sharedConfig.defibrillator, function(source, item)
    -- when someone “uses” their defib, place it on the ground
    TriggerClientEvent('prp-amb:PlaceDefib', source)
end)
-- Example for tourniquet (applies immediately to yourself)
exports.qbx_core:CreateUseableItem(sharedConfig.tourniquet, function(source, item)
    -- you might broadcast a small animation, etc., then heal:
    TriggerClientEvent('prp-amb:healPart', source, source, 'torso', 'tourniquet')
end)
